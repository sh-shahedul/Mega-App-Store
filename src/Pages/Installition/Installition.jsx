...
const Installition = () => {
  ...
  const handelRemove = (id) => {
    toast(<strong>{title}Un-Installed from your Device</strong>);
  ...
  <div>
    {
      ...
      {/* install apps  */}
      {appList.length === 0 ? (
        <div className="  flex justify-center items-center p-30 flex-col gap-y-7">
          <p className="text-3xl text-violet-600 font-bold  ">No Data Avaiable</p>
