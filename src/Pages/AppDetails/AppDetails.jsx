    ...
    <div className="bg-base-200">
      ...
      <div className=" md:flex justify-start items-start md:p-8 gap-30 ">
        <figure className="  bg-gray-200  rounded-lg  ">
          <img
            className="md:h-[270px] md:w-[370px]  "
            src={image}
            alt={title}
          />
        </figure>
        <div className=" md:p-0 p-2 ">
          ...
          <h2 className="text-lg mt-2">
            Developed by{" "}
            <span className="font-bold text-violet-600">{companyName}</span>
          </h2>
          ...
          <div className="flex justify-start md:items-center items-start md:gap-20 gap-10 mt-5">
            <div>
              ...
              <h5 className="md:font-base text-sm text-gray-500 mt-2">
                Downloads
              </h5>
          ...
          <div className="card-actions justify-start mt-4">
            ...
            >
              {isDisabled ? "Installed" : `Install Now (${size})`}{" "}
            </button>
            <button
              onClick={() => Navigate(-1)}
              className=" px-4 py-2 rounded font-bold text-white  bg-violet-600  hover:text-violet-600 hover:bg-white  hover:border-2 hover:border-violet-600"
            >
              Go Back
            </button>
          </div>
