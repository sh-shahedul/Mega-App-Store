      ...
      <figure className="  bg-gray-200  rounded-lg  ">
       ...
       <div className=" md:p-0 p-2 ">
          <h2 className=" text-3xl font-bold ">{title}</h2>
           <h2 className='text-lg mt-2'>beceloped by <span className='font-bold text-violet-600'>{companyName}</span></h2>
        ...
        isDisabled ? "bg-violet-400 cursor-not-allowed" : "bg-[#00D390] hover:bg-white hover:text-[#00D390] "
