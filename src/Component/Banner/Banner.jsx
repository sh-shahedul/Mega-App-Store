...
const Banner = () => {
    return (
        <div className=' max-w-screen-2xl mx-auto bg-base-200 text-center md:py-15 py-7'>
           <h1 className='text-5xl font-bold'> We Build <br /> <span className='text-violet-600'>Productive</span> Apps</h1> 
            <p className='font-semibold text-base mt-4 text-gray-500'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.  <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
