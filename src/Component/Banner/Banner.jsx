    ...
    return (
        <div className='  bg-base-200 text-center md:py-10 py-7'>
           <h1 className='md:text-5xl text-3xl font-bold'> We Build <br /> <span className='text-violet-600'>Productive</span> Apps</h1> 
            <p className='font-semibold md:text-base text-[16px] max-w-[780px] mx-auto mt-4 text-gray-500 p-1'>Mega App Store, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.   Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
        ...
        <div className='bg-gradient-to-r from-violet-600 to-fuchsia-500 md:px-10 md:py-10 px-2 py-4 '>
            <h1 className='md:text-3xl text-lg font-semibold text-white'>Trusted by Millions, Built for You</h1>
            <div className='flex justify-center md:gap-20 gap-5 items-center md:mt-7 mt-3'>
                <div>
